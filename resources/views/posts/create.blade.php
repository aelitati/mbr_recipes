...
@section('content')
    ...
    <div class="container mx-auto mt-8">
        <h3 class="text-gray-700 text-3xl font-medium">Добавить рецепт</h3>

        <div class="mt-8"></div>

        <div class="mt-8">
            <form enctype="multipart/form-data" class="space-y-5 mt-5" method="POST" action="{{ isset($post) ? route("admin.posts.update", $post->id) : route("posts.store") }}">
                @csrf
