                ...
                <nav class="mt-10">
                    ...
                    <a href="{{ route('admin.posts.index') }}"
                       class="text-gray-100 flex items-center mt-4 py-2 px-6">
                        ...
                        <span class="mx-3">Рецепты</span>
                    </a>
                     <!-- Добавленная кнопка для ингредиентов -->
    <a href="{{ route('admin.ingredients.create') }}" class="text-gray-100 flex items-center mt-4 py-2 px-6">
        <span class="mx-3">Ингредиенты</span>
    </a>
</nav>
